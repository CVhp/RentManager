        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <!-- form start -->
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/users/modify">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="birthdate" class="form-control" id="birthdate" name="birthdate" placeholder="Date de naissance" value ="${birthdate}">
                                    </div>
                                </div>
