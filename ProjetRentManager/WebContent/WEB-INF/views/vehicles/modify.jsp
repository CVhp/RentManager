            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box">
                        ...
                        <!-- /vehicles/create -->
                        <form class="form-horizontal" method="post" action="${pageContext.request.contextPath}/cars/modify">
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="manufacturer" name="manufacturer" placeholder="Marque" value ="${manufacturer}" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="seats" name="seats" placeholder="Nombre de places" value ="${seats}" required>
                                    </div>
                                </div>
                                <!--
                                <div class="form-group">
